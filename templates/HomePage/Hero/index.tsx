            ...
            <div className="container relative" ref={parallaxRef}>
                <div className="relative z-1 max-w-[62rem] mx-auto mb-[3.875rem] text-center md:mb-20 lg:mb-[6.25rem]">
                    <h1 className="h1 mb-6">
                        Decentralized&nbsp;Community&nbsp;for {" "}
                        <span className="inline-block relative">
                            Models + Datasets + Compute
                            <Image
                    ...
                    <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
                         A decentralized network where the machine learning community collaborates on models, datasets, and applications.
